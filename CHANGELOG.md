...
* **ci:** at attestation for release artifacts ([#12](https://github.com/npalm/terraform-aws-github-runner/issues/12)) ([efc7c05](https://github.com/npalm/terraform-aws-github-runner/commit/efc7c0575614516a27758c8373fce541702e5cbb))

## [7.0.2](https://github.com/npalm/terraform-aws-github-runner/compare/v7.0.1...v7.0.2) (2025-01-10)


### Bug Fixes

* add attestations ([#9](https://github.com/npalm/terraform-aws-github-runner/issues/9)) ([641d286](https://github.com/npalm/terraform-aws-github-runner/commit/641d286f008c908ce34c15b3e53fd5f17c5561ff))

## [7.0.1](https://github.com/npalm/terraform-aws-github-runner/compare/v7.0.0...v7.0.1) (2025-01-10)


### Bug Fixes

* t attestation for release artifacts ([#7](https://github.com/npalm/terraform-aws-github-runner/issues/7)) ([29d9e2a](https://github.com/npalm/terraform-aws-github-runner/commit/29d9e2a74998f8f68affb1f9354578ecc6a151e8))

## [7.0.0](https://github.com/npalm/terraform-aws-github-runner/compare/v6.1.0...v7.0.0) (2025-01-10)


### ⚠ BREAKING CHANGES

* Enable eventbridge by default ([#4320](https://github.com/npalm/terraform-aws-github-runner/issues/4320))
* remove deprecated metric feature flag ([#4319](https://github.com/npalm/terraform-aws-github-runner/issues/4319))
* Upgrade Node to 22 (LTS) ([#4318](https://github.com/npalm/terraform-aws-github-runner/issues/4318))
* remove deprecated variables ([#4073](https://github.com/npalm/terraform-aws-github-runner/issues/4073))
* Remove FIFO queues ([#4072](https://github.com/npalm/terraform-aws-github-runner/issues/4072))
* remove deprecated runners_scale_up_Lambda_memory_size as it breaks CDKTF ([#4276](https://github.com/npalm/terraform-aws-github-runner/issues/4276))
* remove depcrecated input and output variables ([#3567](https://github.com/npalm/terraform-aws-github-runner/issues/3567))
* Change runner labels to list[string] and apply TFLint ([#3410](https://github.com/npalm/terraform-aws-github-runner/issues/3410))
* replace Amazon Linux 2 by Amazon Linux 2023 as default Linux AMI ([#3437](https://github.com/npalm/terraform-aws-github-runner/issues/3437))

### Features

* add AMI house keeping lambda ([#3570](https://github.com/npalm/terraform-aws-github-runner/issues/3570)) ([87104e8](https://github.com/npalm/terraform-aws-github-runner/commit/87104e8c09a9aaa6069be85c9b68920e455ff715))
* add failover to on-demand in case request is failing ([#3409](https://github.com/npalm/terraform-aws-github-runner/issues/3409)) ([d71e631](https://github.com/npalm/terraform-aws-github-runner/commit/d71e631f3befe7aa15a56c52ba8ead2be71be460))
* Add metric to track GitHub app rate limit ([#4088](https://github.com/npalm/terraform-aws-github-runner/issues/4088)) ([d7cdaed](https://github.com/npalm/terraform-aws-github-runner/commit/d7cdaed26ec8b57fef058ebace4a3dde725ad0b8))
* Add option to set lambda memory increase webhook memory ([#3778](https://github.com/npalm/terraform-aws-github-runner/issues/3778)) ([40bceb6](https://github.com/npalm/terraform-aws-github-runner/commit/40bceb6db1d4bed7959b35a7b23f2b2d21ddc447))
* Add public IP association to github runner ([#3547](https://github.com/npalm/terraform-aws-github-runner/issues/3547)) ([1a25b2c](https://github.com/npalm/terraform-aws-github-runner/commit/1a25b2c6bced8ab4657ace64ef0b6694140856de))
* add spot termination handler ([#4176](https://github.com/npalm/terraform-aws-github-runner/issues/4176)) ([8ba0a82](https://github.com/npalm/terraform-aws-github-runner/commit/8ba0a821dd741d863facb86e621f5d8b596e9273))
* add spot termination watcher (beta) ([#3789](https://github.com/npalm/terraform-aws-github-runner/issues/3789)) ([b2dc794](https://github.com/npalm/terraform-aws-github-runner/commit/b2dc794f08c932470dae846dad0e0a5f33a68cc4))
* add support for matcher config tiering options ([#3953](https://github.com/npalm/terraform-aws-github-runner/issues/3953)) ([5f9d9eb](https://github.com/npalm/terraform-aws-github-runner/commit/5f9d9eb3f9fbda10495b9a2194dc91867942276e))
* add time zone support for pool schedules ([#4063](https://github.com/npalm/terraform-aws-github-runner/issues/4063)) ([b8f9eb4](https://github.com/npalm/terraform-aws-github-runner/commit/b8f9eb4638efbb45a7e27ddb66b3a10eef2617a7))
* add variable to configure ebs optimization for runner instances ([479b779](https://github.com/npalm/terraform-aws-github-runner/commit/479b779a71c77a62dd28d247f8a74cb75ce083f0))
* add variable to configure ebs optimization for runner instances ([#3901](https://github.com/npalm/terraform-aws-github-runner/issues/3901)) ([479b779](https://github.com/npalm/terraform-aws-github-runner/commit/479b779a71c77a62dd28d247f8a74cb75ce083f0))
* added changes to enable tracing in lambdas. ([#3554](https://github.com/npalm/terraform-aws-github-runner/issues/3554)) ([970e8a6](https://github.com/npalm/terraform-aws-github-runner/commit/970e8a657a9a3d62966c75c6738eba7292c77aa8))
* allow caller to provide custom userdata ([#3798](https://github.com/npalm/terraform-aws-github-runner/issues/3798)) ([ac49daf](https://github.com/npalm/terraform-aws-github-runner/commit/ac49daf4afb14b6710d2d652bc2c0f51fc2af98f))
* allow setting VPC and subnets per runner ([#3467](https://github.com/npalm/terraform-aws-github-runner/issues/3467)) ([1288c81](https://github.com/npalm/terraform-aws-github-runner/commit/1288c81de1b9905a71b8f44c03efaf526384b0f2))
* Allow to disable runner max scaling check ([#3849](https://github.com/npalm/terraform-aws-github-runner/issues/3849)) ([e05a043](https://github.com/npalm/terraform-aws-github-runner/commit/e05a043b7354f42f391a1b5319bc850d4e8b2c02))
* Enable eventbridge by default ([#4320](https://github.com/npalm/terraform-aws-github-runner/issues/4320)) ([142bb61](https://github.com/npalm/terraform-aws-github-runner/commit/142bb61539c00e5fc661725c4fc924c4128484cc))
* **lambda:** add option to define explicit lambda tags ([#3934](https://github.com/npalm/terraform-aws-github-runner/issues/3934)) ([7e98943](https://github.com/npalm/terraform-aws-github-runner/commit/7e98943c0b8962ebd0a231da233b431ba692c321))
* mark orphan runners before removing them ([#4001](https://github.com/npalm/terraform-aws-github-runner/issues/4001)) ([6cde62c](https://github.com/npalm/terraform-aws-github-runner/commit/6cde62c8c1d6d5eafae01bf9770bd12bb423d779))
* migrate webhook runner configuration to SSM ([#3728](https://github.com/npalm/terraform-aws-github-runner/issues/3728)) ([32492e3](https://github.com/npalm/terraform-aws-github-runner/commit/32492e3780509d4ff67d0ed3ad55f3506174974c))
* namespace EC2 tags ([#3523](https://github.com/npalm/terraform-aws-github-runner/issues/3523)) ([35aa73a](https://github.com/npalm/terraform-aws-github-runner/commit/35aa73ac1e6df30d4a5c314457da5646a117131b))
* Natively support runner pre/post job hooks ([#4263](https://github.com/npalm/terraform-aws-github-runner/issues/4263)) ([259a852](https://github.com/npalm/terraform-aws-github-runner/commit/259a852d9e1b08f18abe81c9fd80589be9cc7e64))
* order label matchers for multi-runners ([#3591](https://github.com/npalm/terraform-aws-github-runner/issues/3591)) ([1829721](https://github.com/npalm/terraform-aws-github-runner/commit/1829721cb647b005ca44b5feb8d0de27217e6074))
* **packer:** Allow passing in an instance_profile to packer ([#4278](https://github.com/npalm/terraform-aws-github-runner/issues/4278)) ([bb7346b](https://github.com/npalm/terraform-aws-github-runner/commit/bb7346bee8340af03a61e85a3cb129da68543612))
* remove deprecated bata feature workflow job queue ([#4249](https://github.com/npalm/terraform-aws-github-runner/issues/4249)) ([4066c4e](https://github.com/npalm/terraform-aws-github-runner/commit/4066c4eefdf778702cf3490336c92a9755581eaf))
* replace Amazon Linux 2 by Amazon Linux 2023 as default Linux AMI ([#3437](https://github.com/npalm/terraform-aws-github-runner/issues/3437)) ([35219f5](https://github.com/npalm/terraform-aws-github-runner/commit/35219f5b35dcdd780e1a7d3d6b109933914233da))
* Restrict instance SSM permissions ([#3918](https://github.com/npalm/terraform-aws-github-runner/issues/3918)) ([9399cf2](https://github.com/npalm/terraform-aws-github-runner/commit/9399cf29bec963dfa305f367f37c098a76130371))
* **runners:** add retry logic to default install and start script for dnf operations ([#3787](https://github.com/npalm/terraform-aws-github-runner/issues/3787)) ([6a8e1f0](https://github.com/npalm/terraform-aws-github-runner/commit/6a8e1f03e122f99006c488e544c6cf3b672fa304))
* **runners:** add support to disable default labels (Linux) ([#3491](https://github.com/npalm/terraform-aws-github-runner/issues/3491)) ([772e1a5](https://github.com/npalm/terraform-aws-github-runner/commit/772e1a59906f171c6dc70183544443509f9c0580))
* **runners:** add support to disable default labels (Windows) ([#4261](https://github.com/npalm/terraform-aws-github-runner/issues/4261)) ([ad9bcc4](https://github.com/npalm/terraform-aws-github-runner/commit/ad9bcc47f8105098811175379b9eed68d73f7d92))
* scale up for long waiting jobs (job retry) ([#4064](https://github.com/npalm/terraform-aws-github-runner/issues/4064)) ([6120571](https://github.com/npalm/terraform-aws-github-runner/commit/6120571a959bd672c2bbc77ebf05825185c90bc6))
* SSM housekeeper ([#3577](https://github.com/npalm/terraform-aws-github-runner/issues/3577)) ([340deea](https://github.com/npalm/terraform-aws-github-runner/commit/340deeaee94fa9cddbe11d9421cb06c35f2a2726))
* support AWS EventBridge ([#4188](https://github.com/npalm/terraform-aws-github-runner/issues/4188)) ([9607ca6](https://github.com/npalm/terraform-aws-github-runner/commit/9607ca65a8b2c9a62936b28e823c6d7865d3ca38))
* Update default runtime from nodejs18.x to nodejs20.x ([#3791](https://github.com/npalm/terraform-aws-github-runner/issues/3791)) ([11ace32](https://github.com/npalm/terraform-aws-github-runner/commit/11ace32b0a1283c65a19fe7035c0a9835f6cdeab))
* upgrade lambda runtime from 18x to 20x ([#3682](https://github.com/npalm/terraform-aws-github-runner/issues/3682)) ([02dd3e6](https://github.com/npalm/terraform-aws-github-runner/commit/02dd3e64db3a8a026613f010f6654970c8daf6c2))
* Upgrade Node to 22 (LTS) ([#4318](https://github.com/npalm/terraform-aws-github-runner/issues/4318)) ([c5d4693](https://github.com/npalm/terraform-aws-github-runner/commit/c5d4693c7e8889ee9f1672385e26278275d771c2))
* Use Instance Metadata Service Version 2 by default. ([#3513](https://github.com/npalm/terraform-aws-github-runner/issues/3513)) ([d8d69c3](https://github.com/npalm/terraform-aws-github-runner/commit/d8d69c34b0492f125a9d23689e356d04021fe434))
* **webhook:** Enable authorizer assignment to webhook ([#4000](https://github.com/npalm/terraform-aws-github-runner/issues/4000)) ([b78ccde](https://github.com/npalm/terraform-aws-github-runner/commit/b78ccde771f6c24b736e046cd41acb72308baac0))


### Bug Fixes

* add attestations ([#4](https://github.com/npalm/terraform-aws-github-runner/issues/4)) ([04b10d7](https://github.com/npalm/terraform-aws-github-runner/commit/04b10d76f8ffc534eb0f57dc0f1d1229988c6c34))
* add missing prefix to ami cleanur for event rule ([#4098](https://github.com/npalm/terraform-aws-github-runner/issues/4098)) ([1ad118b](https://github.com/npalm/terraform-aws-github-runner/commit/1ad118bd516cc29919a2ec9deb9c9362f635f953))
* Add missing SG and subnet configuration for Job Retry lambda ([#4114](https://github.com/npalm/terraform-aws-github-runner/issues/4114)) ([7095487](https://github.com/npalm/terraform-aws-github-runner/commit/7095487325d4f63acd246e508e2e997cf13a2249))
* Add missing webhook_events_workflow_job_queue_policy to multi-runner queue ([#3848](https://github.com/npalm/terraform-aws-github-runner/issues/3848)) ([a8cba4e](https://github.com/npalm/terraform-aws-github-runner/commit/a8cba4e3795c6105636530ede9360e3123c92c3a))
* add retry logic to runner start script for libicu download ([#3748](https://github.com/npalm/terraform-aws-github-runner/issues/3748)) ([1b4597b](https://github.com/npalm/terraform-aws-github-runner/commit/1b4597b613dc46dcc63cacb546ff4ce489cd731f))
* add runner name prefix to context of scale-up lambda ([#3644](https://github.com/npalm/terraform-aws-github-runner/issues/3644)) ([2936edd](https://github.com/npalm/terraform-aws-github-runner/commit/2936edde98bbd19349396ec575d810caa4f75efb))
* add tags to aws resources ([#3549](https://github.com/npalm/terraform-aws-github-runner/issues/3549)) ([c747139](https://github.com/npalm/terraform-aws-github-runner/commit/c74713923635d51e37cca98449a396a73f71a7bc))
* add warnings to log for GitHub rate limits ([#3988](https://github.com/npalm/terraform-aws-github-runner/issues/3988)) ([2ed0b29](https://github.com/npalm/terraform-aws-github-runner/commit/2ed0b29960a7eb932090cdd3612680c9efc3a5b8))
* adding missing permissions to boundaries ([#3873](https://github.com/npalm/terraform-aws-github-runner/issues/3873)) ([93e8d27](https://github.com/npalm/terraform-aws-github-runner/commit/93e8d2746b647539212dbc65887ec748a1d734b7))
* align inlince policies ([#4046](https://github.com/npalm/terraform-aws-github-runner/issues/4046)) ([7235cdc](https://github.com/npalm/terraform-aws-github-runner/commit/7235cdc40686f3218e1991ec9a8feeb900b719f1)), closes [#4045](https://github.com/npalm/terraform-aws-github-runner/issues/4045)
* allow use of associate_public_ipv4_address from top-level module ([#3572](https://github.com/npalm/terraform-aws-github-runner/issues/3572)) ([0ff7b23](https://github.com/npalm/terraform-aws-github-runner/commit/0ff7b2389fcbb607cdc37392b1612a14e9511c43))
* broken docs after removing examples ([#4321](https://github.com/npalm/terraform-aws-github-runner/issues/4321)) ([7171215](https://github.com/npalm/terraform-aws-github-runner/commit/71712159cd4ad8ae6cb6371e0342b1c6bf663c54))
* bump node dependencies and cleanup ([#4020](https://github.com/npalm/terraform-aws-github-runner/issues/4020)) ([221958b](https://github.com/npalm/terraform-aws-github-runner/commit/221958bccb56642ae654d0a27eb2b27a17013700))
* change log level for termination watcher if no match ([#3866](https://github.com/npalm/terraform-aws-github-runner/issues/3866)) ([649ad35](https://github.com/npalm/terraform-aws-github-runner/commit/649ad35b63f519739354b8bc801dff6c70d66f46))
* Change runner labels to list[string] and apply TFLint ([#3410](https://github.com/npalm/terraform-aws-github-runner/issues/3410)) ([0b398f2](https://github.com/npalm/terraform-aws-github-runner/commit/0b398f2f1010e0af84022a6d11d696cdcb9eb1ec))
* Correct typo in README.md ([#3758](https://github.com/npalm/terraform-aws-github-runner/issues/3758)) ([7186c1c](https://github.com/npalm/terraform-aws-github-runner/commit/7186c1ce48cdeb4ec017d3303f8b7f69d609891a))
* dependency updates lambda ([#3965](https://github.com/npalm/terraform-aws-github-runner/issues/3965)) ([a6df2b6](https://github.com/npalm/terraform-aws-github-runner/commit/a6df2b65dd74a911e9403f7ae7a03230d5003e8e))
* Disable interpolation of HEREDOC strings containing runner hook scripts ([#4333](https://github.com/npalm/terraform-aws-github-runner/issues/4333)) ([2622589](https://github.com/npalm/terraform-aws-github-runner/commit/26225898b6a55d38f96938c95ba55c7b0319343d))
* dispatch only queued events to runners ([#4257](https://github.com/npalm/terraform-aws-github-runner/issues/4257)) ([a0a8322](https://github.com/npalm/terraform-aws-github-runner/commit/a0a8322b539edab279a8570507f6f83ec11a290a))
* **examples:** webhook-github-app multiple character args ([#3625](https://github.com/npalm/terraform-aws-github-runner/issues/3625)) ([941682e](https://github.com/npalm/terraform-aws-github-runner/commit/941682e8ffa04df6976f8f2f9e91ffe3aa4f6b66))
* **images:** avoid wrong AMI selected for ubuntu jammy ([#3747](https://github.com/npalm/terraform-aws-github-runner/issues/3747)) ([595aec9](https://github.com/npalm/terraform-aws-github-runner/commit/595aec9833dd1d1b1383449c0a8ea2284ed98406))
* improve logging when there is an error retrieving ssm parameters ([#3962](https://github.com/npalm/terraform-aws-github-runner/issues/3962)) ([1498c8c](https://github.com/npalm/terraform-aws-github-runner/commit/1498c8c2bdc4e1df8fd3671f2cc2c59d86c3eb92))
* Incorrect syncer binary location in tf outputs ([#4274](https://github.com/npalm/terraform-aws-github-runner/issues/4274)) ([401a373](https://github.com/npalm/terraform-aws-github-runner/commit/401a373684a6b11acd705fe88afee19f3fa84b4c)), closes [#4137](https://github.com/npalm/terraform-aws-github-runner/issues/4137)
* job retry resource and queue naming ([#4099](https://github.com/npalm/terraform-aws-github-runner/issues/4099)) ([4344f18](https://github.com/npalm/terraform-aws-github-runner/commit/4344f18c4518ac0aa135bbdd8b4af13b34d36d63))
* **lambda:** Bump @aws-lambda-powertools/logger from 1.12.1 to 1.14.0 in /lambdas ([#3521](https://github.com/npalm/terraform-aws-github-runner/issues/3521)) ([3f42529](https://github.com/npalm/terraform-aws-github-runner/commit/3f425297c4458d3dc31f45d1a22302ba39c59000))
* **lambda:** bump @aws-lambda-powertools/logger from 1.14.0 to 1.14.2 in /lambdas ([#3611](https://github.com/npalm/terraform-aws-github-runner/issues/3611)) ([1292c6b](https://github.com/npalm/terraform-aws-github-runner/commit/1292c6bf262c088be70119857327f332ddfea4ec))
* **lambda:** bump @aws-lambda-powertools/logger from 1.17.0 to 1.18.0 in /lambdas ([#3754](https://github.com/npalm/terraform-aws-github-runner/issues/3754)) ([98131ff](https://github.com/npalm/terraform-aws-github-runner/commit/98131ffd44b735e120d64e9a77020dc5733021d0))
* **lambda:** bump @aws-lambda-powertools/tracer from 1.14.2 to 1.16.0 in /lambdas ([#3622](https://github.com/npalm/terraform-aws-github-runner/issues/3622)) ([ba73565](https://github.com/npalm/terraform-aws-github-runner/commit/ba73565220179dd685c19d5c0cb57634f9d24fa8))
* **lambda:** bump @aws-lambda-powertools/tracer from 1.16.0 to 1.17.0 in /lambdas ([#3675](https://github.com/npalm/terraform-aws-github-runner/issues/3675)) ([b3536f7](https://github.com/npalm/terraform-aws-github-runner/commit/b3536f7cb37a36643cf7beffd1629440bda221ca))
* **lambda:** bump @aws-sdk/client-ec2 from 3.637.0 to 3.641.0 in /lambdas in the aws group ([#4106](https://github.com/npalm/terraform-aws-github-runner/issues/4106)) ([20f51a1](https://github.com/npalm/terraform-aws-github-runner/commit/20f51a14f9e95630ac88b29f3fb9b1b41189c864))
* **lambda:** bump @middy/core from 3.6.2 to 4.7.0 in /lambdas ([#3609](https://github.com/npalm/terraform-aws-github-runner/issues/3609)) ([2d0f039](https://github.com/npalm/terraform-aws-github-runner/commit/2d0f039f6b2e0b0bec4cb501e4797820c26531e8))
* **lambda:** bump @octokit/auth-app from 6.1.1 to 6.1.2 in /lambdas in the octokit group ([#4117](https://github.com/npalm/terraform-aws-github-runner/issues/4117)) ([6e6bd98](https://github.com/npalm/terraform-aws-github-runner/commit/6e6bd98246fd589a1b1187443c6f5ca36f0ba95c))
* **lambda:** bump @octokit/auth-app from 6.1.2 to 6.1.3 in /lambdas in the octokit group ([#4252](https://github.com/npalm/terraform-aws-github-runner/issues/4252)) ([25f3538](https://github.com/npalm/terraform-aws-github-runner/commit/25f3538d59dd76ecea704727c754e0407610f0d3))
* **lambda:** bump @octokit/types from 13.5.0 to 13.6.0 in /lambdas in the octokit group ([#4154](https://github.com/npalm/terraform-aws-github-runner/issues/4154)) ([825b465](https://github.com/npalm/terraform-aws-github-runner/commit/825b465daeae53cc319d49b749d994c19057f5a1))
* **lambda:** bump @octokit/types from 13.5.0 to 13.6.1 in /lambdas in the octokit group ([#4183](https://github.com/npalm/terraform-aws-github-runner/issues/4183)) ([f24469f](https://github.com/npalm/terraform-aws-github-runner/commit/f24469faac1769e7ab9f1e5d950ab067a4522a1b))
* **lambda:** bump @octokit/types from 13.6.1 to 13.6.2 in /lambdas in the octokit group ([#4291](https://github.com/npalm/terraform-aws-github-runner/issues/4291)) ([d8d7519](https://github.com/npalm/terraform-aws-github-runner/commit/d8d75191eb4573d07ce3ee7f78bfb246b46e1198))
* **lambda:** bump @octokit/types from 13.6.1 to 13.6.2 in /lambdas in the octokit group ([#4303](https://github.com/npalm/terraform-aws-github-runner/issues/4303)) ([9f76c4c](https://github.com/npalm/terraform-aws-github-runner/commit/9f76c4c7b12814da32310153ae668a657da30458))
* **lambda:** bump axios from 1.5.1 to 1.6.0 in /lambdas ([#3604](https://github.com/npalm/terraform-aws-github-runner/issues/3604)) ([a316b82](https://github.com/npalm/terraform-aws-github-runner/commit/a316b8226cb05f5ed9b586549892fa0ab4cb52b8))
* **lambda:** bump axios from 1.6.0 to 1.6.1 in /lambdas ([#3612](https://github.com/npalm/terraform-aws-github-runner/issues/3612)) ([ab3627f](https://github.com/npalm/terraform-aws-github-runner/commit/ab3627f989564aa65efaa6b33c666870a9710aa8))
* **lambda:** bump axios from 1.6.2 to 1.6.7 in /lambdas ([#3755](https://github.com/npalm/terraform-aws-github-runner/issues/3755)) ([80a34bd](https://github.com/npalm/terraform-aws-github-runner/commit/80a34bd7eaafa49c774263ae5406bdc74255d250))
* **lambda:** bump axios from 1.6.7 to 1.6.8 in /lambdas ([#3814](https://github.com/npalm/terraform-aws-github-runner/issues/3814)) ([513b22f](https://github.com/npalm/terraform-aws-github-runner/commit/513b22f6291d9437aae41367098096ca6377547b))
* **lambda:** bump axios from 1.7.2 to 1.7.4 in /lambdas ([#4071](https://github.com/npalm/terraform-aws-github-runner/issues/4071)) ([2f32195](https://github.com/npalm/terraform-aws-github-runner/commit/2f3219597f3729a2e0b7e464048e3119958b62cd))
* **lambda:** bump axios from 1.7.2 to 1.7.5 in /lambdas ([#4100](https://github.com/npalm/terraform-aws-github-runner/issues/4100)) ([0f4cd41](https://github.com/npalm/terraform-aws-github-runner/commit/0f4cd419a83b77c47e0bf9923b78f1f61e583955))
* **lambda:** bump axios from 1.7.4 to 1.7.5 in /lambdas ([#4092](https://github.com/npalm/terraform-aws-github-runner/issues/4092)) ([6ed654f](https://github.com/npalm/terraform-aws-github-runner/commit/6ed654f8e01f5348260ce0f6e9f8c490469127e2))
* **lambda:** bump axios from 1.7.5 to 1.7.7 in /lambdas ([#4155](https://github.com/npalm/terraform-aws-github-runner/issues/4155)) ([82a19c1](https://github.com/npalm/terraform-aws-github-runner/commit/82a19c1fcec4c5ddc21bc03dda565ba57fa60388))
* **lambda:** bump axios from 1.7.7 to 1.7.9 in /lambdas ([#4305](https://github.com/npalm/terraform-aws-github-runner/issues/4305)) ([e3cd5b4](https://github.com/npalm/terraform-aws-github-runner/commit/e3cd5b4c5c92ff1107f03f04d691ba8ed214da4d))
* **lambda:** bump braces from 3.0.2 to 3.0.3 in /lambdas ([#3944](https://github.com/npalm/terraform-aws-github-runner/issues/3944)) ([1aef82b](https://github.com/npalm/terraform-aws-github-runner/commit/1aef82b19fd1b53194b07ba650649f6d314e597c))
* **lambda:** bump cross-spawn from 7.0.3 to 7.0.6 in /lambdas ([#4273](https://github.com/npalm/terraform-aws-github-runner/issues/4273)) ([dcec236](https://github.com/npalm/terraform-aws-github-runner/commit/dcec23624b5b0fddc352b9d61cccb18107cc888d))
* **lambda:** bump ejs from 3.1.9 to 3.1.10 in /lambdas ([#3887](https://github.com/npalm/terraform-aws-github-runner/issues/3887)) ([4cca21f](https://github.com/npalm/terraform-aws-github-runner/commit/4cca21fa5c44316e2ef2574563b24218f8ae090d))
* **lambda:** bump follow-redirects from 1.15.2 to 1.15.4 in /lambdas ([#3712](https://github.com/npalm/terraform-aws-github-runner/issues/3712)) ([97c5fcf](https://github.com/npalm/terraform-aws-github-runner/commit/97c5fcf6fe3b94b2af1646e8c18e00b69e608a04))
* **lambda:** bump micromatch from 4.0.7 to 4.0.8 in /lambdas ([#4096](https://github.com/npalm/terraform-aws-github-runner/issues/4096)) ([d200413](https://github.com/npalm/terraform-aws-github-runner/commit/d2004130668ae88fa28e30378472ab17ab899c87))
* **lambda:** bump the aws group across 1 directory with 2 updates ([#3955](https://github.com/npalm/terraform-aws-github-runner/issues/3955)) ([2e094cf](https://github.com/npalm/terraform-aws-github-runner/commit/2e094cf242fd910d2e2451ece3946f7232f048b7))
* **lambda:** bump the aws group across 1 directory with 5 updates ([#4005](https://github.com/npalm/terraform-aws-github-runner/issues/4005)) ([4ca422d](https://github.com/npalm/terraform-aws-github-runner/commit/4ca422d95da447416f0bc1b53e6e0fea70cca4bd))
* **lambda:** bump the aws group across 1 directory with 5 updates ([#4017](https://github.com/npalm/terraform-aws-github-runner/issues/4017)) ([0cd6a85](https://github.com/npalm/terraform-aws-github-runner/commit/0cd6a854ee54b36b2ede20145a2e8a77f5ed534f))
* **lambda:** bump the aws group across 1 directory with 5 updates ([#4191](https://github.com/npalm/terraform-aws-github-runner/issues/4191)) ([bf8a924](https://github.com/npalm/terraform-aws-github-runner/commit/bf8a92465d580af1503b9038c0f04822d6cd8d0e))
* **lambda:** bump the aws group across 1 directory with 5 updates ([#4203](https://github.com/npalm/terraform-aws-github-runner/issues/4203)) ([e12ee80](https://github.com/npalm/terraform-aws-github-runner/commit/e12ee80bb6d1e5b83a8fe092f6364fd2895fd631))
* **lambda:** bump the aws group across 1 directory with 6 updates ([#3890](https://github.com/npalm/terraform-aws-github-runner/issues/3890)) ([d1cd712](https://github.com/npalm/terraform-aws-github-runner/commit/d1cd712204b678a878f22eea75e540cb28d6a3ad))
* **lambda:** bump the aws group across 1 directory with 6 updates ([#3907](https://github.com/npalm/terraform-aws-github-runner/issues/3907)) ([50dda9a](https://github.com/npalm/terraform-aws-github-runner/commit/50dda9a465229bdb8d106e7ebc5d5b1de115a286))
* **lambda:** bump the aws group across 1 directory with 6 updates ([#3949](https://github.com/npalm/terraform-aws-github-runner/issues/3949)) ([76fe9af](https://github.com/npalm/terraform-aws-github-runner/commit/76fe9af0ad25f2d7647c1c838c6a144b55a1105d))
* **lambda:** bump the aws group across 1 directory with 6 updates ([#4159](https://github.com/npalm/terraform-aws-github-runner/issues/4159)) ([fb67693](https://github.com/npalm/terraform-aws-github-runner/commit/fb67693a8a71c2013c24cc8b46317e051c66ee8b))
* **lambda:** bump the aws group across 1 directory with 6 updates ([#4172](https://github.com/npalm/terraform-aws-github-runner/issues/4172)) ([71f4b6e](https://github.com/npalm/terraform-aws-github-runner/commit/71f4b6e19082efec01b057040bdf3b9e26139cc9))
* **lambda:** bump the aws group across 1 directory with 7 updates ([#4288](https://github.com/npalm/terraform-aws-github-runner/issues/4288)) ([039f5db](https://github.com/npalm/terraform-aws-github-runner/commit/039f5dbeb8af6a02a4686572d8e3377e5048fb3b))
* **lambda:** bump the aws group across 1 directory with 7 updates ([#4314](https://github.com/npalm/terraform-aws-github-runner/issues/4314)) ([3f9b768](https://github.com/npalm/terraform-aws-github-runner/commit/3f9b76878987773458fd2d9bb696d1f4d82d5ec2))
* **lambda:** bump the aws group in /lambdas with 4 updates ([#4048](https://github.com/npalm/terraform-aws-github-runner/issues/4048)) ([e32b14b](https://github.com/npalm/terraform-aws-github-runner/commit/e32b14bc246463d50620c354ce84edc0751623c0))
* **lambda:** bump the aws group in /lambdas with 4 updates ([#4290](https://github.com/npalm/terraform-aws-github-runner/issues/4290)) ([eb9c123](https://github.com/npalm/terraform-aws-github-runner/commit/eb9c123e53c02b332f78c92aedb69b9267810410))
* **lambda:** Bump the aws group in /lambdas with 5 updates ([#3525](https://github.com/npalm/terraform-aws-github-runner/issues/3525)) ([1b24342](https://github.com/npalm/terraform-aws-github-runner/commit/1b243426fdb76fc9fff2d244df357f15bbbb7b24))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3530](https://github.com/npalm/terraform-aws-github-runner/issues/3530)) ([0ada33b](https://github.com/npalm/terraform-aws-github-runner/commit/0ada33b99270da88716e7b4a381fae6d7a06fdd3))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3579](https://github.com/npalm/terraform-aws-github-runner/issues/3579)) ([ccb1d32](https://github.com/npalm/terraform-aws-github-runner/commit/ccb1d32be888a28d37417275950afdc01c4ac0da))
* **lambda:** Bump the aws group in /lambdas with 5 updates ([#3595](https://github.com/npalm/terraform-aws-github-runner/issues/3595)) ([581a4bf](https://github.com/npalm/terraform-aws-github-runner/commit/581a4bff74a22c6d9577c35c6bb683d26cfd5cff))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3620](https://github.com/npalm/terraform-aws-github-runner/issues/3620)) ([1b944d5](https://github.com/npalm/terraform-aws-github-runner/commit/1b944d59bbbed7a6b60ba4d205440ff730208230))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3635](https://github.com/npalm/terraform-aws-github-runner/issues/3635)) ([9615e53](https://github.com/npalm/terraform-aws-github-runner/commit/9615e53af45ae80884ea02570603dd9e614140d4))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3647](https://github.com/npalm/terraform-aws-github-runner/issues/3647)) ([aa0de8d](https://github.com/npalm/terraform-aws-github-runner/commit/aa0de8d4f742cf0cc61e87010d70d8aca056f687))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3661](https://github.com/npalm/terraform-aws-github-runner/issues/3661)) ([81da0be](https://github.com/npalm/terraform-aws-github-runner/commit/81da0becd678079e23d0e67a66b8a85a93d09101))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3671](https://github.com/npalm/terraform-aws-github-runner/issues/3671)) ([677965d](https://github.com/npalm/terraform-aws-github-runner/commit/677965df7d392be7a5176837f74b6698b70a4947))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3699](https://github.com/npalm/terraform-aws-github-runner/issues/3699)) ([6fa667f](https://github.com/npalm/terraform-aws-github-runner/commit/6fa667fae7e4302cf643bcdb4ff3c91b1e4ed8d1))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3705](https://github.com/npalm/terraform-aws-github-runner/issues/3705)) ([477c59b](https://github.com/npalm/terraform-aws-github-runner/commit/477c59b3516558b02c98d56db652e634015a953c))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3720](https://github.com/npalm/terraform-aws-github-runner/issues/3720)) ([9a17b13](https://github.com/npalm/terraform-aws-github-runner/commit/9a17b132c999b392e19af690362340508debe1f7))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3730](https://github.com/npalm/terraform-aws-github-runner/issues/3730)) ([7854a5f](https://github.com/npalm/terraform-aws-github-runner/commit/7854a5f7ed0cdbcbedd746f34074637898d5125d))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3743](https://github.com/npalm/terraform-aws-github-runner/issues/3743)) ([7ca40ef](https://github.com/npalm/terraform-aws-github-runner/commit/7ca40ef1f952403e53e78193eceaea1b1bb67ff6))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3753](https://github.com/npalm/terraform-aws-github-runner/issues/3753)) ([9f3aa68](https://github.com/npalm/terraform-aws-github-runner/commit/9f3aa689f1fdd574dc2980fb3d3f6166bd99238b))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3834](https://github.com/npalm/terraform-aws-github-runner/issues/3834)) ([e7e56ea](https://github.com/npalm/terraform-aws-github-runner/commit/e7e56ea9466feedec46c41f0834ebfd05e6f512f))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3846](https://github.com/npalm/terraform-aws-github-runner/issues/3846)) ([9303a10](https://github.com/npalm/terraform-aws-github-runner/commit/9303a108dfd12ff0c63e7aeb55aa814c7f14619c))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#3861](https://github.com/npalm/terraform-aws-github-runner/issues/3861)) ([6119354](https://github.com/npalm/terraform-aws-github-runner/commit/611935472f8551c103544bc074c7ae419b455528))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#4035](https://github.com/npalm/terraform-aws-github-runner/issues/4035)) ([c15c99d](https://github.com/npalm/terraform-aws-github-runner/commit/c15c99db84132b11f886f6f8e5291af5e357b41e))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#4057](https://github.com/npalm/terraform-aws-github-runner/issues/4057)) ([5ecdbad](https://github.com/npalm/terraform-aws-github-runner/commit/5ecdbaddaf255043057e5427e5f62283b7d59be2))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#4082](https://github.com/npalm/terraform-aws-github-runner/issues/4082)) ([70d7731](https://github.com/npalm/terraform-aws-github-runner/commit/70d7731642cf8f26031bae9e2f1a45b8ed1555bb))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#4089](https://github.com/npalm/terraform-aws-github-runner/issues/4089)) ([1405e54](https://github.com/npalm/terraform-aws-github-runner/commit/1405e54adfecb9373af1831a973a92fb2be18998))
* **lambda:** bump the aws group in /lambdas with 5 updates ([#4116](https://github.com/npalm/terraform-aws-github-runner/issues/4116)) ([4a8826b](https://github.com/npalm/terraform-aws-github-runner/commit/4a8826b5b27db929b3cb4de290fdc989ccab8c69))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#3762](https://github.com/npalm/terraform-aws-github-runner/issues/3762)) ([e43fd80](https://github.com/npalm/terraform-aws-github-runner/commit/e43fd80324dd1e553dc81720b39893f1c6dd97d4))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#3772](https://github.com/npalm/terraform-aws-github-runner/issues/3772)) ([3549bc1](https://github.com/npalm/terraform-aws-github-runner/commit/3549bc1824fcf15b7b008eb6ea455a89ae3278df))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#3783](https://github.com/npalm/terraform-aws-github-runner/issues/3783)) ([b850e85](https://github.com/npalm/terraform-aws-github-runner/commit/b850e853e221e4f1026f31e1bfc8d4c73d08c212))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#3803](https://github.com/npalm/terraform-aws-github-runner/issues/3803)) ([eedbf52](https://github.com/npalm/terraform-aws-github-runner/commit/eedbf525a9f1d377d8a1f9fb50d1842eb8947afe))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#3818](https://github.com/npalm/terraform-aws-github-runner/issues/3818)) ([9a9031e](https://github.com/npalm/terraform-aws-github-runner/commit/9a9031ead20546f6a3b939435a801e5aeb8264b8))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#4128](https://github.com/npalm/terraform-aws-github-runner/issues/4128)) ([f6164e7](https://github.com/npalm/terraform-aws-github-runner/commit/f6164e7fb8cfb4776c62e4a1dbea698ba0f2b6d2))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#4146](https://github.com/npalm/terraform-aws-github-runner/issues/4146)) ([43bf911](https://github.com/npalm/terraform-aws-github-runner/commit/43bf911b486fc585c3de4b61ec6aa47aef48e639))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#4235](https://github.com/npalm/terraform-aws-github-runner/issues/4235)) ([ef89b98](https://github.com/npalm/terraform-aws-github-runner/commit/ef89b98ca3494d8dac0a38f7f39a73128e6444af))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#4323](https://github.com/npalm/terraform-aws-github-runner/issues/4323)) ([fbac69a](https://github.com/npalm/terraform-aws-github-runner/commit/fbac69af8bd95bcd0796d787d7b75b5354a39478))
* **lambda:** bump the aws group in /lambdas with 6 updates ([#4336](https://github.com/npalm/terraform-aws-github-runner/issues/4336)) ([1282e11](https://github.com/npalm/terraform-aws-github-runner/commit/1282e113bcda7fb0433b2a8fb5d5ee86c1c27c6b))
* **lambda:** bump the aws group in /lambdas with 7 updates ([#4211](https://github.com/npalm/terraform-aws-github-runner/issues/4211)) ([d18dcaa](https://github.com/npalm/terraform-aws-github-runner/commit/d18dcaa08801228b0b7d8086962de5fb681dafe3))
* **lambda:** bump the aws group in /lambdas with 7 updates ([#4251](https://github.com/npalm/terraform-aws-github-runner/issues/4251)) ([6a98712](https://github.com/npalm/terraform-aws-github-runner/commit/6a98712fd522c1721c7e094204f1723f11e962d8))
* **lambda:** bump the aws group in /lambdas with 7 updates ([#4266](https://github.com/npalm/terraform-aws-github-runner/issues/4266)) ([849549e](https://github.com/npalm/terraform-aws-github-runner/commit/849549e8b6497fa7fc8288739669c8daf1223df8))
* **lambda:** bump the aws-powertools group in /lambdas with 3 updates ([#4058](https://github.com/npalm/terraform-aws-github-runner/issues/4058)) ([f9533f3](https://github.com/npalm/terraform-aws-github-runner/commit/f9533f3423a060f232455aacaa8d4967025f6e2c))
* **lambda:** bump the aws-powertools group in /lambdas with 4 updates ([#4129](https://github.com/npalm/terraform-aws-github-runner/issues/4129)) ([ab2605f](https://github.com/npalm/terraform-aws-github-runner/commit/ab2605f92d8dd8e297c3b063e589d17005330b00))
* **lambda:** bump the aws-powertools group in /lambdas with 4 updates ([#4184](https://github.com/npalm/terraform-aws-github-runner/issues/4184)) ([e18ac60](https://github.com/npalm/terraform-aws-github-runner/commit/e18ac600bbad9df67a1ea02a1155044bfb44cef4))
* **lambda:** bump the aws-powertools group in /lambdas with 4 updates ([#4212](https://github.com/npalm/terraform-aws-github-runner/issues/4212)) ([9c9219b](https://github.com/npalm/terraform-aws-github-runner/commit/9c9219b690c83125a0817f125f499d6155c0cdf1))
* **lambda:** bump the aws-powertools group in /lambdas with 4 updates ([#4281](https://github.com/npalm/terraform-aws-github-runner/issues/4281)) ([e1f330b](https://github.com/npalm/terraform-aws-github-runner/commit/e1f330bb3c8321af875232e23ff1f4d053c684f5))
* **lambda:** bump the aws-powertools group in /lambdas with 4 updates ([#4324](https://github.com/npalm/terraform-aws-github-runner/issues/4324)) ([68cba47](https://github.com/npalm/terraform-aws-github-runner/commit/68cba476bbc3660b619e162d66ac84dedcd0b754))
* **lambda:** Bump the octokit group in /lambdas with 1 update ([#3519](https://github.com/npalm/terraform-aws-github-runner/issues/3519)) ([cde80cd](https://github.com/npalm/terraform-aws-github-runner/commit/cde80cd9e6144e5b6c11f055e601521f277a4932))
* **lambda:** bump the octokit group in /lambdas with 1 update ([#3636](https://github.com/npalm/terraform-aws-github-runner/issues/3636)) ([876db0c](https://github.com/npalm/terraform-aws-github-runner/commit/876db0ce2bf6f39ab3eb4264512086aafbeb65f1))
* **lambda:** bump the octokit group in /lambdas with 1 update ([#3648](https://github.com/npalm/terraform-aws-github-runner/issues/3648)) ([e5dc96b](https://github.com/npalm/terraform-aws-github-runner/commit/e5dc96b49af98da1630aa96bbde0f2589b145941))
* **lambda:** bump the octokit group in /lambdas with 1 update ([#3662](https://github.com/npalm/terraform-aws-github-runner/issues/3662)) ([76697e6](https://github.com/npalm/terraform-aws-github-runner/commit/76697e69c41dd3524496977869c0b6aaa6a07d36))
* **lambda:** bump the octokit group in /lambdas with 1 update ([#3672](https://github.com/npalm/terraform-aws-github-runner/issues/3672)) ([67facac](https://github.com/npalm/terraform-aws-github-runner/commit/67facac961890186eed199ffa685211fbc933adb))
* **lambda:** bump the octokit group in /lambdas with 1 update ([#3706](https://github.com/npalm/terraform-aws-github-runner/issues/3706)) ([af40f28](https://github.com/npalm/terraform-aws-github-runner/commit/af40f28c42d9be68d5bd945624ce390e87f87374))
* **lambda:** bump the octokit group in /lambdas with 1 update ([#3721](https://github.com/npalm/terraform-aws-github-runner/issues/3721)) ([9b13c09](https://github.com/npalm/terraform-aws-github-runner/commit/9b13c099598728d91f58a79b46d460fad12c94a1))
* **lambda:** bump the octokit group in /lambdas with 1 update ([#3763](https://github.com/npalm/terraform-aws-github-runner/issues/3763)) ([77586c5](https://github.com/npalm/terraform-aws-github-runner/commit/77586c5efb6a4e33bb2c056867738c13559292b9))
* **lambda:** bump the octokit group in /lambdas with 2 updates ([#3621](https://github.com/npalm/terraform-aws-github-runner/issues/3621)) ([c54e8c8](https://github.com/npalm/terraform-aws-github-runner/commit/c54e8c896b4f6a19dcc15172671fdf31de6e371d))
* **lambda:** bump the octokit group in /lambdas with 2 updates ([#3773](https://github.com/npalm/terraform-aws-github-runner/issues/3773)) ([de9985a](https://github.com/npalm/terraform-aws-github-runner/commit/de9985a9f6babf83b3c2149247db7ecee602a500))
* **lambda:** bump the octokit group in /lambdas with 2 updates ([#4166](https://github.com/npalm/terraform-aws-github-runner/issues/4166)) ([5573c39](https://github.com/npalm/terraform-aws-github-runner/commit/5573c399ad2d5668561abc33ac02d24bc4c6178a))
* **lambda:** bump typescript from 5.3.3 to 5.4.5 in /lambdas ([#3863](https://github.com/npalm/terraform-aws-github-runner/issues/3863)) ([e3f3d77](https://github.com/npalm/terraform-aws-github-runner/commit/e3f3d779a8f66f2933da0600c6ef3de252fb440d))
* **lambda:** bump typescript from 5.5.4 to 5.6.3 in /lambdas ([#4200](https://github.com/npalm/terraform-aws-github-runner/issues/4200)) ([cb0c1ff](https://github.com/npalm/terraform-aws-github-runner/commit/cb0c1fff3c3d771837a635db4f89a1ef68e9cfaf))
* **lambda:** bump typescript from 5.6.3 to 5.7.2 in /lambdas ([#4293](https://github.com/npalm/terraform-aws-github-runner/issues/4293)) ([f6e4b92](https://github.com/npalm/terraform-aws-github-runner/commit/f6e4b926e6e73bddb7b0b2f78183d3542f26d023))
* **lambda:** Prevent scale-up lambda from starting runner for user repo if org level runners is enabled ([#3909](https://github.com/npalm/terraform-aws-github-runner/issues/3909)) ([98b1560](https://github.com/npalm/terraform-aws-github-runner/commit/98b1560f86bb609110bfdbf3607eb19f23beab0e))
* Loosen the AWS Terraform provider constraint ([#3708](https://github.com/npalm/terraform-aws-github-runner/issues/3708)) ([649da42](https://github.com/npalm/terraform-aws-github-runner/commit/649da42de76a8b3ed895f0f0e6b08d4719198592))
* mark github_app variable as sensitive ([#4013](https://github.com/npalm/terraform-aws-github-runner/issues/4013)) ([08be669](https://github.com/npalm/terraform-aws-github-runner/commit/08be669a9d04bb8c5930b69d17f12748720e6148))
* missing GHES URL for the retry lambda ([#4177](https://github.com/npalm/terraform-aws-github-runner/issues/4177)) ([3afbd5f](https://github.com/npalm/terraform-aws-github-runner/commit/3afbd5fb0952dbb37d7db216f325acf57cc3aa97))
* missing lambda s3 key and version for job retry ([#4074](https://github.com/npalm/terraform-aws-github-runner/issues/4074)) ([8540379](https://github.com/npalm/terraform-aws-github-runner/commit/8540379e36dd0e900e777684a55c51da80a5ef1b))
* **multi-runner:** remove renundant default labels ([#3715](https://github.com/npalm/terraform-aws-github-runner/issues/3715)) ([9353734](https://github.com/npalm/terraform-aws-github-runner/commit/93537347538a8a57516ae1737b96d4c37319af32))
* pass lambda zip file to job retry feature ([#4080](https://github.com/npalm/terraform-aws-github-runner/issues/4080)) ([098c0ea](https://github.com/npalm/terraform-aws-github-runner/commit/098c0ea9ad96d31a2fa944d7eafe90861d8c6184)), closes [#4078](https://github.com/npalm/terraform-aws-github-runner/issues/4078)
* remove depcrecated input and output variables ([#3567](https://github.com/npalm/terraform-aws-github-runner/issues/3567)) ([89c8575](https://github.com/npalm/terraform-aws-github-runner/commit/89c8575bf5df80c9a0861ff63e72a5762edbdcfc))
* remove deprecated metric feature flag ([#4319](https://github.com/npalm/terraform-aws-github-runner/issues/4319)) ([70105b4](https://github.com/npalm/terraform-aws-github-runner/commit/70105b49d166088bd7f522005b95b40b7ab5b2e4))
* remove deprecated runners_scale_up_Lambda_memory_size as it breaks CDKTF ([#4276](https://github.com/npalm/terraform-aws-github-runner/issues/4276)) ([a2280f7](https://github.com/npalm/terraform-aws-github-runner/commit/a2280f74d45475804de730aeaf903670a3400bd1))
* remove deprecated variables ([#4073](https://github.com/npalm/terraform-aws-github-runner/issues/4073)) ([099c78d](https://github.com/npalm/terraform-aws-github-runner/commit/099c78dc5db0ccf71277b1d4941e05e72336cff8))
* remove fetch override for octokit and versions ([#4042](https://github.com/npalm/terraform-aws-github-runner/issues/4042)) ([6ac19e6](https://github.com/npalm/terraform-aws-github-runner/commit/6ac19e6e4aa3a950d26fcaf496d08fe5508d8992))
* Remove FIFO queues ([#4072](https://github.com/npalm/terraform-aws-github-runner/issues/4072)) ([2f20a8b](https://github.com/npalm/terraform-aws-github-runner/commit/2f20a8b9564301346b84eb5baefb22bb313a5408))
* remove job start hook with senstive information ([#3986](https://github.com/npalm/terraform-aws-github-runner/issues/3986)) ([bbcb470](https://github.com/npalm/terraform-aws-github-runner/commit/bbcb4707f698b29c470c0aadf81c9ac2c37781f8)), closes [#3980](https://github.com/npalm/terraform-aws-github-runner/issues/3980)
* remove unused environment variable ([#3616](https://github.com/npalm/terraform-aws-github-runner/issues/3616)) ([bb68562](https://github.com/npalm/terraform-aws-github-runner/commit/bb68562953304dc1f6a6d6d5d2309db5e1e823c0))
* remove unused example spot_instance_termination_watcher ([#4226](https://github.com/npalm/terraform-aws-github-runner/issues/4226)) ([ad865a7](https://github.com/npalm/terraform-aws-github-runner/commit/ad865a7df9393ede2958e53d9ecbb0a61e66053c))
* Replace deprecate aws_cloudwatch_event_rule.is_enabled, requires provide upgrade ([#3655](https://github.com/npalm/terraform-aws-github-runner/issues/3655)) ([3c78f65](https://github.com/npalm/terraform-aws-github-runner/commit/3c78f652a4b2569e1e93ce739e8a9cda62c2128e))
* restrict runner security group to only ingress ([#3564](https://github.com/npalm/terraform-aws-github-runner/issues/3564)) ([e63fdc5](https://github.com/npalm/terraform-aws-github-runner/commit/e63fdc5ec3b85f2b1fa9a4f881588681fee0c07d))
* revert depedency update / broken release 5.10.2 ([#3885](https://github.com/npalm/terraform-aws-github-runner/issues/3885)) ([7464f2b](https://github.com/npalm/terraform-aws-github-runner/commit/7464f2bbb401c9c1b07d252c2572a4a970468e95))
* **runners:** zip base64 encoded user data to avoid size limits ([#3717](https://github.com/npalm/terraform-aws-github-runner/issues/3717)) ([f2bbcb1](https://github.com/npalm/terraform-aws-github-runner/commit/f2bbcb16e2c99dbf58057680564f517e74599d73)), closes [#3700](https://github.com/npalm/terraform-aws-github-runner/issues/3700)
* shorten role name for ssm housekeeper ([#3587](https://github.com/npalm/terraform-aws-github-runner/issues/3587)) ([a1440b5](https://github.com/npalm/terraform-aws-github-runner/commit/a1440b5a1b329e65e860292895714cc3f072a1bb))
* signing ([#6](https://github.com/npalm/terraform-aws-github-runner/issues/6)) ([efd2b57](https://github.com/npalm/terraform-aws-github-runner/commit/efd2b57ab734628e47c6be768651b267ca59267a))
* spot termination watcher output multi runner ([#4194](https://github.com/npalm/terraform-aws-github-runner/issues/4194)) ([367b1b3](https://github.com/npalm/terraform-aws-github-runner/commit/367b1b38285d63c0cc0fb8a991f69dcbac227222))
* support ephemeral runners for windows ([#4164](https://github.com/npalm/terraform-aws-github-runner/issues/4164)) ([44f5d6d](https://github.com/npalm/terraform-aws-github-runner/commit/44f5d6de244f5b23a1992aa36e49e41d605b659b))
* trigger cold start dispatcher after update SSM parameters ([#4243](https://github.com/npalm/terraform-aws-github-runner/issues/4243)) ([580d24b](https://github.com/npalm/terraform-aws-github-runner/commit/580d24b6be14508d34c201fe764f35d34024ea57))
* Typo in env vars for scale-up lambda ([#3891](https://github.com/npalm/terraform-aws-github-runner/issues/3891)) ([f4ecf46](https://github.com/npalm/terraform-aws-github-runner/commit/f4ecf466014d7d51aed238aa851290908d3c7972))
* update dependencies ([#3867](https://github.com/npalm/terraform-aws-github-runner/issues/3867)) ([85b5aac](https://github.com/npalm/terraform-aws-github-runner/commit/85b5aac73931cebdeb779a86118d7b5043286493))
* upgrade aws powertools to v2 ([#4027](https://github.com/npalm/terraform-aws-github-runner/issues/4027)) ([900217b](https://github.com/npalm/terraform-aws-github-runner/commit/900217bd81cb5cabcc8c38e12b8fd380315319e8))
* use name instead of name prefix to avoid too long names ([#4079](https://github.com/npalm/terraform-aws-github-runner/issues/4079)) ([8bb6272](https://github.com/npalm/terraform-aws-github-runner/commit/8bb62724c41b6dbd3d3f484f32da9d46dc5ad853))
* webhook expects REPOSITORY_ALLOW_LIST env var ([#3856](https://github.com/npalm/terraform-aws-github-runner/issues/3856)) ([0006ab9](https://github.com/npalm/terraform-aws-github-runner/commit/0006ab9fb5880fb1daf31b3e1b8d218e7b86105b))
* **webhook-github-app:** Allow new lines in base64 key for module webhook-github-app ([#3714](https://github.com/npalm/terraform-aws-github-runner/issues/3714)) ([57f056d](https://github.com/npalm/terraform-aws-github-runner/commit/57f056dc4a57896d702c8bf056fceb8b3c6e77f8))
* **webhook:** add missing permission to workflow job queue (EventBridge) ([#4224](https://github.com/npalm/terraform-aws-github-runner/issues/4224)) ([d7e516c](https://github.com/npalm/terraform-aws-github-runner/commit/d7e516c4cc8b3c5091937730935efa716e6481bd))
* **webhook:** Avoid jobs are accepted without labels ([#3548](https://github.com/npalm/terraform-aws-github-runner/issues/3548)) ([cb78738](https://github.com/npalm/terraform-aws-github-runner/commit/cb7873819b660be99b336c7ee486405b5cb3c2cb))
* **webhook:** Don't log warning when secondary job queue is empty ([#3942](https://github.com/npalm/terraform-aws-github-runner/issues/3942)) ([ef25bd4](https://github.com/npalm/terraform-aws-github-runner/commit/ef25bd44717d282cc123ada570b0b03cf76b4d7f))
* **webhook:** Don't set `${SQS_WORKFLOW_JOB_QUEUE}` to empty string ([#3943](https://github.com/npalm/terraform-aws-github-runner/issues/3943)) ([6c48dff](https://github.com/npalm/terraform-aws-github-runner/commit/6c48dffff558dba78d013f10764fb65329b6523e))
* **webhook:** grant KMS permission to decrypt wehn using EventBridge ([#4220](https://github.com/npalm/terraform-aws-github-runner/issues/4220)) ([380bcaf](https://github.com/npalm/terraform-aws-github-runner/commit/380bcaf68447fb05be6c888392b46449cf5d409d))
* **webhook:** result message webhook ([#4221](https://github.com/npalm/terraform-aws-github-runner/issues/4221)) ([8099c17](https://github.com/npalm/terraform-aws-github-runner/commit/8099c1766e4b8d63b950cf6a2c360cf95cdd0dab))
* windows userdata does not support gzip ([#3759](https://github.com/npalm/terraform-aws-github-runner/issues/3759)) ([b74df54](https://github.com/npalm/terraform-aws-github-runner/commit/b74df549521f7d8d54eb0e1e436803934cabac3f))
* workflow job event queue misconfiguration. ([#3710](https://github.com/npalm/terraform-aws-github-runner/issues/3710)) ([0a2577e](https://github.com/npalm/terraform-aws-github-runner/commit/0a2577ed250c73ac8272132f7b39874b9957fdbd))
